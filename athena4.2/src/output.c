...
Real expr_Sc (const GridS *pG, const int i, const int j, const int k);
...
#endif
#if NSCALARS > 0
/*! \fn Real expr_Sc(const GridS *pG, const int i, const int j, const int k) 
 *  \brief First scalar */
Real expr_Sc(const GridS *pG, const int i, const int j, const int k) {
